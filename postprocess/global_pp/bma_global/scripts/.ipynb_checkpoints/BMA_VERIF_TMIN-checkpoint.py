...
fn = '/glade/derecho/scratch/ksha/EPRI_data/PP_calib/TMIN_BMA_calib.zarr'
...
fn_save = f'/glade/derecho/scratch/ksha/EPRI_data/PP_verif/TMIN_BMA_{verif_years[0]}_{verif_years[-1]}.zarr'
