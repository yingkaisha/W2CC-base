...
VAR = VAR_CESM = 'TREFHTMX'
VAR_ERA5 = 'maximum_2m_temperature_since_previous_post_processing'
EPS = 1e-6
...
fn = '/glade/derecho/scratch/ksha/EPRI_data/PP_calib/TMAX_BMA_calib.zarr'
...
bma_crps = crps_verif(ds_calib, ds_input, ds_target, date_idx, var=VAR)
...
fn_save = f'/glade/derecho/scratch/ksha/EPRI_data/PP_verif/TMAX_BMA_{verif_years[0]}_{verif_years[-1]}.zarr'
